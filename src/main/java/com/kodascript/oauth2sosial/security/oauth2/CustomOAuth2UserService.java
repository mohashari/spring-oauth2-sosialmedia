...
import com.kodascript.oauth2sosial.security.oauth2.user.OAuth2UserInfo;
import com.kodascript.oauth2sosial.security.oauth2.user.OAuth2UserInfoFactory;
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
        ...
        if (userOptional.isPresent()) {
            ...
            if (!user.getProvider().equals(AuthProvider.valueOf(oAuth2UserRequest.getClientRegistration().getRegistrationId()))) {
                throw new OAuth2AuthenticationProcessingException("Look like you're signed up" +
